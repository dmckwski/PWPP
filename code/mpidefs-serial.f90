...
!
      ...
      contains
         ...
         if(present(mpi_recv_buf_dc).or.present(mpi_send_buf_dc)) then
            if(mpi_command.eq.'bcast'.or.mpi_command.eq.'send'.or.mpi_command.eq.'recv' &
               .or.mpi_command.eq.'reduce'.or.mpi_command.eq.'allreduce' &
               .or.mpi_command.eq.'gather'.or.mpi_command.eq.'scatter' &
               .or.mpi_command.eq.'alltoall') then
